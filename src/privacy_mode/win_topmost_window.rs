...
pub const WIN_TOPMOST_INJECTED_PROCESS_EXE: &'static str = "RuntimeBroker_jwvisdesk.exe";
pub const INJECTED_PROCESS_EXE: &'static str = WIN_TOPMOST_INJECTED_PROCESS_EXE;
pub(super) const PRIVACY_WINDOW_CLASS: &'static str = "JwVisDeskPrivacyWindowClass";
pub(super) const PRIVACY_WINDOW_NAME: &'static str = "JwVisDeskPrivacyWindow";
